...
enum
{
  darknet_ros_msgs__action__CheckForObjects_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  darknet_ros_msgs__action__CheckForObjects_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/CheckForObjects in the package darknet_ros_msgs.
typedef struct darknet_ros_msgs__action__CheckForObjects_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  darknet_ros_msgs__action__CheckForObjects_SendGoal_Request__Sequence request;
  darknet_ros_msgs__action__CheckForObjects_SendGoal_Response__Sequence response;
} darknet_ros_msgs__action__CheckForObjects_SendGoal_Event;

// Struct for a sequence of darknet_ros_msgs__action__CheckForObjects_SendGoal_Event.
typedef struct darknet_ros_msgs__action__CheckForObjects_SendGoal_Event__Sequence
{
...
enum
{
  darknet_ros_msgs__action__CheckForObjects_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  darknet_ros_msgs__action__CheckForObjects_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/CheckForObjects in the package darknet_ros_msgs.
typedef struct darknet_ros_msgs__action__CheckForObjects_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  darknet_ros_msgs__action__CheckForObjects_GetResult_Request__Sequence request;
  darknet_ros_msgs__action__CheckForObjects_GetResult_Response__Sequence response;
} darknet_ros_msgs__action__CheckForObjects_GetResult_Event;

// Struct for a sequence of darknet_ros_msgs__action__CheckForObjects_GetResult_Event.
typedef struct darknet_ros_msgs__action__CheckForObjects_GetResult_Event__Sequence
{
