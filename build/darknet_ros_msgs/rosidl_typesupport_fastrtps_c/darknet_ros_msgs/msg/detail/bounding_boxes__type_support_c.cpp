...
bool cdr_serialize_darknet_ros_msgs__msg__BoundingBox(
  const darknet_ros_msgs__msg__BoundingBox * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_darknet_ros_msgs__msg__BoundingBox(
  eprosima::fastcdr::Cdr & cdr,
  darknet_ros_msgs__msg__BoundingBox * ros_message);
...
bool cdr_serialize_key_darknet_ros_msgs__msg__BoundingBox(
  const darknet_ros_msgs__msg__BoundingBox * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_darknet_ros_msgs__msg__BoundingBox(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_darknet_ros_msgs__msg__BoundingBox(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_darknet_ros_msgs__msg__BoundingBox(
        &array_ptr[i], cdr);
    }
  }
  ...
  darknet_ros_msgs__msg__BoundingBoxes * ros_message)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    auto array_ptr = ros_message->bounding_boxes.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_darknet_ros_msgs__msg__BoundingBox(cdr, &array_ptr[i]);
    }
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_darknet_ros_msgs__msg__BoundingBox(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_darknet_ros_msgs__msg__BoundingBox(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: bounding_boxes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_darknet_ros_msgs__msg__BoundingBox(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const darknet_ros_msgs__msg__BoundingBoxes * ros_message = static_cast<const darknet_ros_msgs__msg__BoundingBoxes *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_darknet_ros_msgs__msg__BoundingBoxes(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  darknet_ros_msgs__msg__BoundingBoxes * ros_message = static_cast<darknet_ros_msgs__msg__BoundingBoxes *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_darknet_ros_msgs__msg__BoundingBoxes(cdr, ros_message);
}
