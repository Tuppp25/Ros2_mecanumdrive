  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const darknet_ros_msgs__msg__BoundingBox * ros_message = static_cast<const darknet_ros_msgs__msg__BoundingBox *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_darknet_ros_msgs__msg__BoundingBox(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  darknet_ros_msgs__msg__BoundingBox * ros_message = static_cast<darknet_ros_msgs__msg__BoundingBox *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_darknet_ros_msgs__msg__BoundingBox(cdr, ros_message);
}
