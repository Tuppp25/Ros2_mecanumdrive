...
class Init_CheckForObjects_SendGoal_Event_response
{
public:
  explicit Init_CheckForObjects_SendGoal_Event_response(::darknet_ros_msgs::action::CheckForObjects_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::darknet_ros_msgs::action::CheckForObjects_SendGoal_Event response(::darknet_ros_msgs::action::CheckForObjects_SendGoal_Event::_response_type arg)
  {
...
private:
  ::darknet_ros_msgs::action::CheckForObjects_SendGoal_Event msg_;
};

class Init_CheckForObjects_SendGoal_Event_request
{
public:
  explicit Init_CheckForObjects_SendGoal_Event_request(::darknet_ros_msgs::action::CheckForObjects_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_CheckForObjects_SendGoal_Event_response request(::darknet_ros_msgs::action::CheckForObjects_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_CheckForObjects_SendGoal_Event_response(msg_);
  }
...
class Init_CheckForObjects_SendGoal_Event_info
{
public:
  Init_CheckForObjects_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_CheckForObjects_SendGoal_Event_request info(::darknet_ros_msgs::action::CheckForObjects_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_CheckForObjects_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::darknet_ros_msgs::action::CheckForObjects_SendGoal_Event>()
{
  return darknet_ros_msgs::action::builder::Init_CheckForObjects_SendGoal_Event_info();
}
...
class Init_CheckForObjects_GetResult_Event_response
{
public:
  explicit Init_CheckForObjects_GetResult_Event_response(::darknet_ros_msgs::action::CheckForObjects_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::darknet_ros_msgs::action::CheckForObjects_GetResult_Event response(::darknet_ros_msgs::action::CheckForObjects_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::darknet_ros_msgs::action::CheckForObjects_GetResult_Event msg_;
};

class Init_CheckForObjects_GetResult_Event_request
{
public:
  explicit Init_CheckForObjects_GetResult_Event_request(::darknet_ros_msgs::action::CheckForObjects_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_CheckForObjects_GetResult_Event_response request(::darknet_ros_msgs::action::CheckForObjects_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_CheckForObjects_GetResult_Event_response(msg_);
  }
...
class Init_CheckForObjects_GetResult_Event_info
{
public:
  Init_CheckForObjects_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_CheckForObjects_GetResult_Event_request info(::darknet_ros_msgs::action::CheckForObjects_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_CheckForObjects_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::darknet_ros_msgs::action::CheckForObjects_GetResult_Event>()
{
  return darknet_ros_msgs::action::builder::Init_CheckForObjects_GetResult_Event_info();
}
